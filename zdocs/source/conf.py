...
htmlhelp_basename = "spanserverdoc"
...
latex_documents = [
    (master_doc, "spanserver.tex", "spanserver Documentation", "Billy PeAKE", "manual")
]
...
man_pages = [(master_doc, "spanserver", "spanserver Documentation", 1)]
